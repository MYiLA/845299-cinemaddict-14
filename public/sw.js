// const CACHE_PREFIX = '845299-cinemaddict-cache';
// const CACHE_VER = 'v14';
...
// // который поместит в кэш все статические ресурсы, кроме файла с самим сервис-воркером. Браузер кэширует его автоматически;
...
// // который будет возвращать из кэша файл, если таковой в нём имеется, чтобы не загружать файл с сервера ещё раз;
...
// // который на каждую активацию сервис-воркера будет удалять с компьютера пользователя устаревшие кэши.
